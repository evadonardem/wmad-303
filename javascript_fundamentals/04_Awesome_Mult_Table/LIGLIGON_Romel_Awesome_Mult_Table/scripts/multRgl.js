...
const awesomeMultTableFormRgl = document.querySelector('#awesomeMultTableFormRgl');

awesomeMultTableFormRgl.onsubmit = (event) => {
    ...
    for (let i = 1; i <= rows; i++) {
        ...
        for (let j = 1; j <= cols; j++) {
            ...
            tableRows += `<td><p class = "alert alert-${isEven}">
            ${prod}
            </p>
            </td>`;
        }
