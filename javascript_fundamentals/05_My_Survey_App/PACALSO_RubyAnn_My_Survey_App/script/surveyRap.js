let tally = [
    ...
    { socmed: 'instagram', count: 0, color: 'rgba(255, 255, 0, 0.2)', borderColor: 'rgba(255, 255, 0, 0.2)' },
    { socmed: 'twitter', count: 0, color: 'rgba(0, 255, 0, 0.2)', borderColor: 'rgba(0, 255, 0, 0.2)' }
];
